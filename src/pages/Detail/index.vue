          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="spu in spuSaleAttrList" :key="spu.id">
                ...
                <dd
                  changepirce="0"
                  v-for="spuVal in spu.spuSaleAttrValueList"
                  :key="spuVal.id"
                  :class="{ active: spuVal.isChecked === '1' }"
                  @click="changeActive(spuVal, spu.spuSaleAttrValueList)"
                >
                ...
                <input
                  ...
                  @change="
                    $event.target.value * 1 >= 1
                      ? (skuNum = Math.ceil($event.target.value * 1))
                      : (skuNum = 1)
                  "
                />
...
export default {
  ...
  methods: {
    getDetailPageInfo() {
      this.$store.dispatch("getDetailPageInfo", this.skuId);
    },
    //点击选择高亮
    changeActive(spuVal, spu) {
      spu.forEach((item) => (item.isChecked = "0"));
      spuVal.isChecked = "1";
    },
    //购物车
    async toCart() {
          ...
          .chooseArea {
            ...
            dl {
              ...
              dd {
                ...
                &.active {
                  color: rgb(38, 32, 122);
                  border: 1px solid rgb(189, 49, 154);
                }
              }
            }
          }
